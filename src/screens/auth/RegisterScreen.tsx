...
import { registerUser } from "../../api/e2e";
	...
	async function handleRegister() {
		...
		try {
			...
			if (error instanceof ApiError) {
				Alert.alert("Erro", `${error.message} (status: ${error.status})`);
				return;
      }

			Alert.alert("Errddo", "Nao foi possivel criar sua conta agora.");
		}
	}
			...
			>
				...
				<View style={styles.hintRow}>
					...
					<Text style={styles.hintText}>
						{" "}
						Mínimo de 8 caracteres e um número
					</Text>
				</View>
